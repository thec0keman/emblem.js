  ...
  var Parser = (function() {
    ...
    function parse(input) {
      var options = arguments.length > 1 ? arguments[1] : {},
          ...
          peg$c75 = { type: "other", description: "_1BeginStatement" },
          peg$c76 = { type: "other", description: "_1ContentStatement" },
          peg$c77 = function() { return []; },
          peg$c78 = ">",
          peg$c79 = { type: "literal", value: ">", description: "\">\"" },
          peg$c80 = function(n, params) {
          ...
          peg$c85 = function(mustacheTuple) {
          ...
          peg$c89 = function(ret, multilineContent) {
            if(multilineContent) {
          ...
          peg$c92 = function(h) { return h;},
          peg$c93 = function(h, nested) {
          ...
          peg$c94 = function(mustacheContent, blockTuple) {
            if (blockTuple) {
          ...
          peg$c97 = function(statements) { return statements; },
          peg$c98 = function(statements) {
              return statements;
            },
          peg$c99 = function(i) { return i },
          peg$c100 = function(block) {
              return block;
            },
          peg$c101 = function(e, mustacheTuple) {
            var mustache = mustacheTuple[0];
            var block = mustacheTuple[1];
          ...
          peg$c102 = function(isPartial, mustache) {
            if(isPartial) {
          ...
          peg$c103 = function(t) { return ['tagName', t]; },
          peg$c104 = function(i) { return ['elementId', i]; },
          peg$c105 = function(c) { return ['class', c]; },
          peg$c106 = function(a) {
            return a;
          },
          peg$c107 = function(p) { return p; },
          peg$c108 = function(a) { return a; },
          peg$c109 = { type: "other", description: "_1PathIdent" },
          peg$c110 = "..",
          ...
          peg$c117 = function(segmentLiteral) { return segmentLiteral; },
          peg$c118 = { type: "other", description: "_1Key" },
          peg$c119 = ":",
          peg$c120 = { type: "literal", value: ":", description: "\":\"" },
          peg$c121 = function(s, p) { return { part: p, separator: s }; },
          ...
          peg$c123 = { type: "other", description: "_1PathSeparator" },
          peg$c124 = /^[\/.]/,
          ...
          peg$c127 = function(v) { return new AST.StringNode(v); },
          peg$c128 = function(v) { return new AST.NumberNode(v); },
          peg$c129 = function(v) { return new AST.BooleanNode(v); },
          peg$c130 = { type: "other", description: "_1Boolean" },
          peg$c131 = "true",
          peg$c132 = { type: "literal", value: "true", description: "\"true\"" },
          peg$c133 = "false",
          peg$c134 = { type: "literal", value: "false", description: "\"false\"" },
          peg$c135 = { type: "other", description: "_1Integer" },
          peg$c136 = function(s) { return parseInt(s); },
          peg$c137 = function(p) { return p[1]; },
          peg$c138 = /^[^"}]/,
          ...
          peg$c150 = function(w) { return w;},
          peg$c151 = function(s, nodes, indentedNodes) {
            var i, l;
          ...
          peg$c152 = function(first, tail) {
            return flattenArray(first, tail);
          },
          peg$c153 = function(first, tail) { return flattenArray(first, tail); },
          peg$c154 = "{",
          ...
          peg$c163 = { type: "other", description: "_1SingleMustacheOpen" },
          peg$c164 = { type: "other", description: "_1DoubleMustacheOpen" },
          peg$c165 = "{{",
          peg$c166 = { type: "literal", value: "{{", description: "\"{{\"" },
          peg$c167 = { type: "other", description: "_1TripleMustacheOpen" },
          peg$c168 = "{{{",
          peg$c169 = { type: "literal", value: "{{{", description: "\"{{{\"" },
          peg$c170 = { type: "other", description: "_1SingleMustacheClose" },
          peg$c171 = "}",
          peg$c172 = { type: "literal", value: "}", description: "\"}\"" },
          peg$c173 = { type: "other", description: "_1DoubleMustacheClose" },
          peg$c174 = "}}",
          peg$c175 = { type: "literal", value: "}}", description: "\"}}\"" },
          peg$c176 = { type: "other", description: "_1TripleMustacheClose" },
          peg$c177 = "}}}",
          peg$c178 = { type: "literal", value: "}}}", description: "\"}}}\"" },
          peg$c179 = { type: "other", description: "_1SubexpressionOpen" },
          peg$c180 = { type: "other", description: "_1SubexpressionClose" },
          peg$c181 = { type: "other", description: "_1InterpolationOpen" },
          peg$c182 = "#{",
          peg$c183 = { type: "literal", value: "#{", description: "\"#{\"" },
          peg$c184 = { type: "other", description: "_1InterpolationClose" },
          peg$c185 = "==",
          peg$c186 = { type: "literal", value: "==", description: "\"==\"" },
          peg$c187 = function() { return true; },
          peg$c188 = function(h, s) { return h || s; },
          peg$c189 = " [",
          peg$c190 = { type: "literal", value: " [", description: "\" [\"" },
          peg$c191 = function(h, inTagMustaches, fullAttributes) {
          ...
          peg$c199 = function(id) { return id; },
          peg$c200 = function(event, mustacheNode) {
          ...
          peg$c201 = function(key, boolValue) {
            if (boolValue === 'true') {
              return [key];
            }
          },
          peg$c202 = function(value) { return value.replace(/ *$/, ''); },
          ...
          peg$c204 = function(key, id) {
            return [key, '{{' + id + '}}'];
          },
          peg$c205 = function(key, nodes) {
            var strings = [];
          ...
          peg$c209 = { type: "other", description: "_1CSSIdentifier" },
          peg$c210 = /^[_a-zA-Z0-9\-]/,
          peg$c211 = { type: "class", value: "[_a-zA-Z0-9\\-]", description: "[_a-zA-Z0-9\\-]" },
          peg$c212 = /^[_a-zA-Z]/,
          peg$c213 = { type: "class", value: "[_a-zA-Z]", description: "[_a-zA-Z]" },
          peg$c214 = /^[\x80-\xFF]/,
          peg$c215 = { type: "class", value: "[\\x80-\\xFF]", description: "[\\x80-\\xFF]" },
          peg$c216 = { type: "other", description: "_1KnownHTMLTagName" },
          peg$c217 = function(t) { return !!KNOWN_TAGS[t]; },
          peg$c218 = function(t) { return t; },
          peg$c219 = { type: "other", description: "_1a JS event" },
          peg$c220 = function(t) { return !!KNOWN_EVENTS[t]; },
          peg$c221 = { type: "other", description: "_1INDENT" },
          peg$c222 = function(t) { return preprocessor.INDENT_SYMBOL === t; },
          peg$c223 = function(t) { return ''; },
          peg$c224 = { type: "other", description: "_1DEDENT" },
          peg$c225 = function(t) { return preprocessor.DEDENT_SYMBOL === t; },
          peg$c226 = { type: "other", description: "_1Unmatched DEDENT" },
          peg$c227 = function(t) { return preprocessor.UNMATCHED_DEDENT_SYMBOL === t; },
          peg$c228 = { type: "other", description: "_1LineEnd" },
          peg$c229 = function(t) { return preprocessor.TERM_SYMBOL == t; },
          peg$c230 = function(t) { return false; },
